...
#define XIAOMI_TOUCH                            1

#define TP_INFO_TP_LOCKDOWN                     1

#define LCT_TP_WORK_EN                          1

#define LCT_TP_SELFTEST                         1

#define LCT_TP_VIRTUAL_PSENSOR                  1

#define LCT_TP_GESTURE_EN                       1

#define LCT_TP_GRIP_AREA_EN                     1

#define LCT_TP_USB_CHARGE                       1
/****************************************************/
 ...
 */
#define FTS_MODULE_NAME                         "samsung_ft3519t"
