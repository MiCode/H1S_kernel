...
extern void mi_power_regmap_register(struct regmap *regmap);
...
static int pmic_spmi_probe(struct spmi_device *sdev)
{
	...
	//just /d/regmap/0-00 for main pmic
	if (!strcmp(dev_name(&sdev->dev), "0-00"))
		mi_power_regmap_register(regmap);
