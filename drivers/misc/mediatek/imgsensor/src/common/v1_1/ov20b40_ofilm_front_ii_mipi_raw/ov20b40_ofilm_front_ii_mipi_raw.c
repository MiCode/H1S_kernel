 ...
 * Filename:
 * ---------
 *     ov20b40_ofilm_front_ii_mipi_raw.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov20b40_ofilm_front_ii_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV20B40_OFILM_FRONT_II_SENSOR_ID,
...
static kal_uint32 ov20b40ofilm_ana_gain_table[] = {
	1024,
	1088,
	1152,
	1216,
...
#define OV20B40C_OFILM_EEPROM_I2C_ADDR 0xA2
static kal_uint16 read_ov20b40_ofilm_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, OV20B40C_OFILM_EEPROM_I2C_ADDR);
...
static kal_uint32 return_vendor_id(void)
{
	...
	vendor_id = read_ov20b40_ofilm_eeprom_module(0x0001);
	return vendor_id;
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if ((*sensor_id == imgsensor_info.sensor_id) && (vendor_id == 0x07)) {
...
break;
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(ov20b40ofilm_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)ov20b40ofilm_ana_gain_table,
			sizeof(ov20b40ofilm_ana_gain_table));
		}
		break;
...
UINT32 OV20B40_OFILM_FRONT_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
