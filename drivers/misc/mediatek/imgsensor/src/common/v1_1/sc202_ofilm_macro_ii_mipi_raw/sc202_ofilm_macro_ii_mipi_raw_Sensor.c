 ...
 * Filename:
 * ---------
 *     sc202_ofilm_macro_ii_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "sc202_ofilm_macro_ii_mipi_raw_Sensor.h"
#include "imgsensor_custom.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202_ofilm_macro_ii_mipi_raw"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202_OFILM_MACRO_II_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108))+1; //0xeb53
}
...
#define SC202PCS_SENSOR_GAIN_MAX              16384 //(16 * SC202PCS_SENSOR_GAIN_BASE)
#define SC202PCS_SENSOR_GAIN_MAX_VALID_INDEX  5
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	// }
	pr_err("macro-aac getimgsensorid!!!\n");
...
UINT32 SC202_OFILM_MACRO_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SC202_OFILM_MACRO_II_MIPI_RAW_SensorInit    */
