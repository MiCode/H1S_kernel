 ...
 * Filename:
 * ---------
 *     sc202_aac_macro_ii_mipi_raw_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef SC202_OFILM_MACRO_II_MIPI_RAW_SENSOR_H
#define SC202_OFILM_MACRO_II_MIPI_RAW_SENSOR_H
...
#define SC200PCS_VALID_IXEL_NUMS            800
#define SC200PCS_VALID_LINE_NUMS            1200
#define SC200PCS_DEFAULT_DUMMY_PIXEL_NUMS   0x11c //244 
#define SC200PCS_DEFAULT_DUMMY_LINE_NUMS    0x0e //64
#define SC200PCS_INTERNAL_DUMMY_PIXEL_NUMS  36
#define SC200PCS_INTERNAL_DUMMY_LINE_NUMS   32
#define SC200PCS_VIDEO_PERIOD_PIXEL_NUMS          (1120)
#define SC200PCS_VIDEO_PERIOD_LINE_NUMS           (1246)
#define SC200PCS_PV_PERIOD_PIXEL_NUMS            (1120)
#define SC200PCS_PV_PERIOD_LINE_NUMS             (1246)
#define SC200PCS_FULL_PERIOD_PIXEL_NUMS          (1120)
#define SC200PCS_FULL_PERIOD_LINE_NUMS           (1246)
// end
