...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202CS_AAC_DEPTH_I_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)) + 2; //0xeb52 -> 0xeb54
}
...
UINT32 SC202CS_AAC_DEPTH_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
