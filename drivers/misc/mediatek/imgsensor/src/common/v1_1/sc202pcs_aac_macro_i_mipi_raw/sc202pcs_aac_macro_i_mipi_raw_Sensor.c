 ...
 * Filename:
 * ---------
 *     sc202pcs_aac_macro_i_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "sc202pcs_aac_macro_i_mipi_raw_Sensor.h"
#include "imgsensor_custom.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202pcs_aac_macro_i_mipi_raw"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202PCS_AAC_MACRO_I_SENSOR_ID,
...
UINT32 SC202PCS_AAC_MACRO_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SC202PCS_AAC_MACRO_I_MIPI_RAW_SensorInit    */
