...
#include "sc820cs_aac_ultra_i_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC820CS_AAC_ULTRA_I_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (vendor_id != VENDOR_ID){
		LOG_INF("SC820CS_AAC get_vendor_id read is %x!", vendor_id);
...
UINT32 SC820CS_AAC_ULTRA_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
