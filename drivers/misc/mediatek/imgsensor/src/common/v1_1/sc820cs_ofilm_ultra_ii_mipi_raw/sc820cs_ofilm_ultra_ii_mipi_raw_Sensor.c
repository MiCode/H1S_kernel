...
#include "sc820cs_ofilm_ultra_ii_mipi_raw_Sensor.h"
#include "imgsensor_custom.h"

#define PFX "sc820cs_ofilm_camera_sensor"
#define LOG_INF(format, args...)    \
    pr_debug(PFX "[%s] " format, __func__, ##args)
#define VENDOR_ID 0x07
static IMGSENSOR_GET_CUSTOM_INFO_STRUCT custom_info = {
    .sensor_type = SENSOR_REAR_ULTRA,
	.module_head = "ofil",
	.fuse_id = "",
	.fuse_id_len = 12,
	.sn_info = "",
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC820CS_OFILM_ULTRA_II_SENSOR_ID,
    ...
    .custom1 = {
        .pclk = 132000000,             //To be done max_framerate = 240
        .linelength = 1760,
        .framelength = 3125,
        .startx = 0,
        .starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 { 3264, 2448,    0,    0, 3264, 2448, 1632, 1224, 0000, 0000, 1632, 1224,    0,    0, 1632, 1224}, // zaki copy from video for shortvideo
};
#if MULTI_WRITE
...
{
    return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108))+1; //0xd155
}
...
#define SC820CS_SENSOR_GAIN_MAX              (320 * SC820CS_SENSOR_GAIN_BASE / 10)
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor8(0x36ea,0x0b);
    ...
    write_cmos_sensor8(0x3018,0x32);
    write_cmos_sensor8(0x3019,0x0c);
    write_cmos_sensor8(0x301f,0x10);
    write_cmos_sensor8(0x3037,0x60);
    ...
    write_cmos_sensor8(0x3654,0x30);
    ...
    write_cmos_sensor8(0x4819,0x0a);
    write_cmos_sensor8(0x481b,0x06);
    write_cmos_sensor8(0x481d,0x16);
    write_cmos_sensor8(0x481f,0x05);
    write_cmos_sensor8(0x4821,0x09);
    write_cmos_sensor8(0x4823,0x05);
    write_cmos_sensor8(0x4825,0x05);
    write_cmos_sensor8(0x4827,0x05);
    write_cmos_sensor8(0x4829,0x09);
...
static void slim_video_setting(void)
{
    ...
    write_cmos_sensor8(0x3018,0x32);
    write_cmos_sensor8(0x3019,0x0c);
    write_cmos_sensor8(0x301f,0x4b);
    write_cmos_sensor8(0x3037,0x60);
    write_cmos_sensor8(0x3200,0x00);
    write_cmos_sensor8(0x3201,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_sc820cs[] = {
0x0103,0x01,
0x36e9,0x80,
0x37f9,0x80,
0x36ea,0x0b,
...
static void custom1_setting(void)
{
#if MULTI_WRITE
    sc820cs_table_write_cmos_sensor(
        addr_data_pair_custom1_sc820cs,
        sizeof(addr_data_pair_custom1_sc820cs) /
        sizeof(kal_uint16));
#else
    write_cmos_sensor8(0x0103,0x01);
    write_cmos_sensor8(0x36e9,0x80);
    ...
    write_cmos_sensor8(0x5900,0xf1);
    write_cmos_sensor8(0x5901,0x04);
	write_cmos_sensor8(0x320e,0x0c);
    write_cmos_sensor8(0x320f,0x35);
#endif
}

/*
static void read_sc820cs_barley_module_data()
{
// ov08d10_barley_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
    ...
    memset(sc820cs_barley_common_data, 0,sizeof(sc820cs_barley_common_data));
    // QR
    for(idx = 0; idx < sn_length; idx++)
    {
        sc820cs_barley_common_data[8 + idx] = read_sc820cs_barley_eeprom_module(sn_starAddr + idx);
    }
    //vcm
    sc820cs_barley_common_data[40] = read_sc820cs_barley_eeprom_module(vcmAddr);
    sc820cs_barley_common_data[41] = read_sc820cs_barley_eeprom_module(vcmAddr + 1);
    //lensid
    sc820cs_barley_common_data[44] = read_sc820cs_barley_eeprom_module(lensAddr);
    sc820cs_barley_common_data[45] = read_sc820cs_barley_eeprom_module(lensAddr + 1);
    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4) {
        LOG_INF("cam data: %02x %02x %02x %02x\n",
               sc820cs_barley_common_data[idx],
               sc820cs_barley_common_data[idx + 1],
               sc820cs_barley_common_data[idx + 2],
               sc820cs_barley_common_data[idx + 3]);
    }
}*/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (vendor_id != VENDOR_ID){
		LOG_INF("SC820CS_OFILM get_vendor_id read is %x!", vendor_id);
            ...
            do {
                *sensor_id =return_sensor_id();
                if (*sensor_id == imgsensor_info.sensor_id) {
                   ...
                   // read_sc820cs_barley_module_data();
...
static kal_uint32 open(void)
{
    ...
    LOG_INF("preview 3264*2448@30fps,660Mbps/lane;"
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
  ...
  /*  case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, sc820cs_barley_common_data, CAMERA_EEPPROM_COMDATA_LENGTH);
...
UINT32 SC820CS_OFILM_ULTRA_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
