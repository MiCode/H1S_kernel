...
int fsm_pos_mask_to_index(uint8_t pos_mask)
{
	int pos_idx;
 ...
 * 0x01: right2
 */
int fsm_amp_set_switch(uint8_t pos_mask, bool on)
{
...
EXPORT_SYMBOL_GPL(fsm_amp_set_switch);
